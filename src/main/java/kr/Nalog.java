			...
			public boolean isValidInput(JTextField jtxt, String description) {
				...
				if (jtxt.getText().trim().length() > 0) {
					try {
						...
						jtxt.requestFocus();
						jtxt.setText("");
						JOptionPane.showMessageDialog(D, "Вы должны ввести число!", "Ошибка",
	...
	public static void main1(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				JLabel label_1, label_n1, label_n2, label_n3, label_n4, label_n5, label_n6, label_n7, label_n8,
						label_n9, label_n10, label_n11, label_n12, label_n13, label_n14, label_n15, label_n16,
